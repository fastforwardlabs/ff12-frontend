...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, '>')) : null, frame != finish_line ? pause ? __jsx("button", {
    style: {
      marginLeft: '2ch'
    },
    onClick: function onClick() {
    ...
    __self: this
  }, "Pause") : null, pause && frame != finish_line ? __jsx("button", {
    style: {
      marginLeft: '2ch'
    },
    onClick: function onClick() {

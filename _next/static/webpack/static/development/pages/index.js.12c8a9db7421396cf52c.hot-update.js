...

      {
        ...
        for (var _i = 0; _i < rank_rows.length; _i++) {
          ...
          for (var c = 0; c < 3; c++) {
            ...
            var _w3 = row[c + 2] / 100 * xstep - cw;

            sx.fillRect(x, y, _w3, h);
          }
        }
        ...
        for (var _i2 = 0; _i2 < rank_rows.length; _i2++) {
          ...
          var _w4 = _panel3[4] / 100 * cw;

          ix.fillStyle = bgs[_row[0]];
          ix.fillRect(0, _y, _w4, step);
        }
      }
    }
  }, [data, frame]);

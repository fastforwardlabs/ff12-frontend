...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "The VISUALIZED section provides another view of each strategy's performance. Each connection is visualized as a square."), __jsx("div", {
    style: {
      display: 'flex',
      marginTop: rlh / 4,
      marginBottom: rlh / 4
    ...
    __self: this
  }, "If classified normal, it is placed on the right.")), __jsx("div", {
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_5___default.a.dynamic([["2318732879", [fs, lh, rlh]]]),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 1284

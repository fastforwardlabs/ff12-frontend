    ...
    if (data !== null) {
      ...
      for (var r = 0; r < pr; r++) {
        for (var c = 0; c < pc; c++) {
          ...
          var _y = r * (top + ph + bottom + bottom_space) + top;

          var w = pw;
          var _h = ph;
          pdim[i] = [x, _y, w, _h];
          vx.fillRect(x, _y, w, _h);
        }
      }

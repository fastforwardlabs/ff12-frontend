...
function Index() {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      __self: this
    }, frame + (termheight - i) - termheight)), d.slice(0, 19).map(function (d, j) {
      return __jsx("div", {
        style: {
          display: 'flex',
          paddingLeft: '1ch',

...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.slice(Math.max(frame - termheight + 1, 0), Math.min(frame + 1, finish_line - 1)).reverse().map(function (d, i) {
    return __jsx("div", {

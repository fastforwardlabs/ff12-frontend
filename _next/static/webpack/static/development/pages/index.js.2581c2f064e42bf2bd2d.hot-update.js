...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.data.slice(Math.max(frame - termheight, 1), frame + 1).reverse().map(function (d, i) {
    return __jsx("div", {

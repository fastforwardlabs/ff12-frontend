...
function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      ...
      var vheight = (_top + ph + bottom + bottom_space) * 2 + _top + bottom + bottom_space;
      ...
      for (var r = 0; r < pr; r++) {
        for (var c = 0; c < pc; c++) {
          var i = r * pc + c;
          var x = c * (pw + size * 4);
          var y = r * (_top + ph + bottom + bottom_space) + _top;
          var w = pw;
          var _h = ph;
          pdim[i] = [x, y, w, _h];
      ...
      for (var _r = 0; _r < pr; _r++) {
        for (var _c = 0; _c < pc; _c++) {
          ...
          $t.style.top = _r * (_top + ph + bottom + bottom_space) + 'px';
          $t.style.width = pw + 'px';
      ...
      tt.style.left = cw + 'px';
      tt.style.top = 2 * (_top + ph + bottom + bottom_space) + 'px';
      ...
      for (var _r2 = 0; _r2 < pr; _r2++) {
        for (var _c2 = 0; _c2 < pc; _c2++) {
          ...
          $r.style.top = _r2 * (_top + ph + bottom + bottom_space) + _top + ph + 'px';
          $r.style.width = pw + 'px';
      ...
      tre.style.top = 2 * (_top + ph + bottom + bottom_space) + rlh + 'px';
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      ...
      for (var i = 0; i < panels.length; i++) {
        ...
        hx.fillStyle = 'rgba(0, 0, 0, 0)';
        hx.fillRect(left, top, h.width, h.height);
        hx.fillStyle = 'pink';

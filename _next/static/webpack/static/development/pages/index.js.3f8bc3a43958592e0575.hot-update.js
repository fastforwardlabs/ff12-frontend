    ...
    if (data !== null) {
...

      {
        ...
        for (var _i = 0; _i < rank_rows.length; _i++) {
          ...
          TP.toString().padStart(4, '0');
          FP.toString().padStart(4, '0');
          TN.toString().padStart(4, '0');
          FN.toString().padStart(4, '0');

...
function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      var _panels = panels_ref.current;
      var $read = readout_ref.current;
      var pdim = pdim_ref.current;
      var v = vref.current;
      var vx = v.getContext('2d');
      ...
      for (var i = 0; i < _panels.length; i++) {
        ...
        if (detected > 0.1) {
          ...
          var _n = _panels[i][2] + _panels[i][3];
        ...
        _panels[i][4] = accuracy;
        _panels[i][5] = precision;
        _panels[i][6] = recall;
      }

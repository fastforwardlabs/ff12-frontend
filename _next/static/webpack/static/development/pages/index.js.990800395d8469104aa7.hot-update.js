...
function Index() {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: name,
      style: {
        background: bgs[name.indexOf(name)],
        paddingLeft: '3ch'
      },
      className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_4___default.a.dynamic([["2318732879", [fs, lh, rlh]]]),
      __source: {

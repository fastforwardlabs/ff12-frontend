  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      ...
      for (var i = 0; i < panels.length; i++) {
        ...
        hx.fillRect(dim[0] + p1x - 3, dim[1] + p1y - 3, size + 1 + 6, size + 1 + 6);
        hx.fillStyle = vx.fillStyle;

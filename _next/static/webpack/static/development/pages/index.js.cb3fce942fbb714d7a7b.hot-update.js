...
function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      ...
      var records = data.data.slice(Math.max(0, frame - termheight), frame);
      ...
      for (var i = 0; i < records.length; i++) {
        ...
        for (var j = 0; j < row.childNodes.length - 1; j++) {
          ...
          if (j === 0) {
            ...
            if (_cell.innerHTML != record[j]) {
              _cell.innerHTML = record[j];
            }
          }
        }
      }

...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.slice(Math.max(Math.min(frame - termheight + 1, finish_line - 1 - termheight + 1), 0), Math.min(frame + 1, finish_line - 1)).reverse().map(function (d, i) {
    return __jsx("div", {
      ...
      __self: this
    }, Math.min(frame, finish_line) + (termheight - i) - termheight)), d.slice(0, 18).map(function (d, j) {
      return __jsx("div", {
        style: {
          display: 'flex',
          paddingLeft: '1ch',

    ...
    if (data !== null) {
      ...
      for (var _r = 0; _r < pr; _r++) {
        for (var c = 0; c < pc; c++) {
          var i = _r * pc + c;
          var x = c * (pw + size * 4);
          var y = _r * (top + ph + bottom + bottom_space) + top;
          var w = pw;
          var _h = ph;
          pdim[i] = [x, y, w, _h];
      ...
      for (var _r2 = 0; _r2 < pr; _r2++) {
        for (var _c = 0; _c < pc; _c++) {
          var $t = $titles.childNodes[_r2 * pc + _c];
          $t.style.position = 'absolute';
          $t.style.top = _r2 * (top + ph + bottom + bottom_space) + 'px';
          $t.style.width = pw + 'px';
      ...
      for (var _r3 = 0; _r3 < pr; _r3++) {
        for (var _c2 = 0; _c2 < pc; _c2++) {
          var $r = $read.childNodes[_r3 * pc + _c2];
          $r.style.position = 'absolute';
          $r.style.top = _r3 * (top + ph + bottom + bottom_space) + top + ph + 'px';
          $r.style.width = pw + 'px';

...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "The VISUALIZED section provides another view of each strategy's performance. Each connection is visualized as a", __jsx("span", {
    style: {
      display: 'inline-block',
      width: size,
      height: size,

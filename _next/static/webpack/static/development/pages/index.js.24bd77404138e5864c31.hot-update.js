...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "The STRATEGIES section shows metrics on how each algorithm is performing on the incoming data. You can see the accuracy, recall, and precision metrics for each strategy. The metrics are calculated using the number of True Positives (attacks classified as attacks), False Positives (normal connections classified as attacks), True Negatives (normal connections classified as normal), and False Negatives (attacks classified as normal connections) for each algorithm."), __jsx("div", {
    style: {
      marginBottom: rlh / 2
    },
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_5___default.a.dynamic([["2318732879", [fs, lh, rlh]]]),

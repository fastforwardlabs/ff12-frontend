...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.data.slice(0, frame).reverse().map(function (d, i) {
    return __jsx("div", {
      style: {
        display: 'flex'
      },

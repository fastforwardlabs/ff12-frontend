    ...
    if (data !== null) {
...

      {
        ...
        for (var _i = 0; _i < rank_rows.length; _i++) {
          ...
          $r.childNodes[1].childNodes[0].innerHTML = isNaN(row[2]) ? row[2] + '% ' : '- ';
          $r.childNodes[1].childNodes[1].innerHTML = "(".concat(TP, "+").concat(TN, ")/").concat(total);
          $r.childNodes[2].childNodes[0].innerHTML = isNaN(row[3]) ? row[3] + '% ' : '- ';
          $r.childNodes[2].childNodes[1].innerHTML = "".concat(TP, "/(").concat(TP, "+").concat(FP, ")");
          $r.childNodes[3].childNodes[0].innerHTML = isNaN(row[4]) ? row[4] + '% ' : '- ';

...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.data.slice(frame - 4, frame).map(function (d, i) {
    return __jsx("div", {
      style: {
        display: 'flex'
      },

...
function Index() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, data.data.slice(Math.max(frame - 4, 0), frame).reverse().map(function (d, i) {
    return __jsx("div", {
      key: frame + (4 - i) - 4,
      style: {
        display: 'flex' // background: d[19] ? red : scheme.bg,

  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (data !== null) {
      ...
      for (var i = 0; i < panels.length; i++) {
        ...
        var dim = pdim[i];
        vx.clearRect(dim[0] + p1x, dim[1] + p1y, size + 1, size + 1);
